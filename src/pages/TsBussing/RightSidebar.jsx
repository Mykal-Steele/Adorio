...
const RightSidebar = () => {
  return (
    <div className="w-full z-30 shadow-[-4px_0_24px_rgba(0,0,0,0.5)] h-auto md:h-auto overflow-y-auto border-l-0 md:border-l-0 border-t-8 md:border-t-8 border-amber-900 cork-pattern md:col-start-1 md:row-start-2 ts-right-sidebar">
