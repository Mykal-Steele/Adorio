...
const TsBussing = () => {
  return (
    <main className="min-h-screen text-neutral-200 font-main selection:bg-amber-900 selection:text-white grid grid-cols-1 md:grid-cols-[320px_1fr] md:overflow-y-auto bg-[#2e2e2e] ts-bussing-layout">
      <AdSenseScript />
      {/* Background Image */}
      <div
