...
const LeftSidebar = () => {
  return (
    <div className="w-full z-30 flex flex-col shadow-[4px_0_24px_rgba(0,0,0,0.5)] overflow-y-auto h-auto md:h-auto relative wood-pattern-dark row-start-1 col-start-1 ts-left-sidebar">
