...
const Shelf = ({ category, iconName, speed, items }) => {
  ...
  const tiltStyle = useMemo(() => {
    ...
    const angle = ((Math.abs(hash) % 200) / 100 - 1).toFixed(2);
  ...
  return (
    <div className="mb-16 relative" style={tiltStyle}>
      <div className="relative z-10 flex items-end">
        <div className="mx-auto relative w-full max-w-300">
          <div className="bg-neutral-800 rounded-3xl p-4 pb-8 border-t-4 border-neutral-600 shadow-2xl relative">
            <div className="bg-black rounded-2xl overflow-hidden p-1 relative">
              <div className="relative screen-glow overflow-hidden min-h-80 flex flex-col justify-center">
                <div
      ...
      <div className="h-8 w-[120%] -ml-[10%] -mt-0.5 relative shadow-2xl rounded-sm wood-pattern-light">
