...
// (a feed card, an image) is actually sitting behind them. A solid backdrop
// color there makes the tear look like it's painted on top of a rectangle
// instead of genuinely overlapping the page underneath it.
//
// Two things keep the shape legible against an unpredictable backdrop
// (a same-colored card, a busy photo):
// 1. Each spike fills from a gradient — solid cream for a short buffer at
//    the top (so it still reads as one seamless color with the Navbar),
//    fading to a darker tan for most of the spike's height, darkest at the tip.
// 2. A second, unfilled path retraces just the jagged edge (not the flat top,
//    or the stroke would draw a seam line against the Navbar) with a thin
//    dark stroke, so there's a hard edge that doesn't depend on color
//    contrast with whatever happens to be behind it.
//
  ...
  <div className="sticky top-14 z-40 h-4 w-full bg-transparent sm:top-16 sm:h-6">
    ...
    >
      ...
      <path
        ...
        d="M1200,14 L1080,26 L960,13 L840,27 L720,14 L600,25 L480,12 L360,26 L240,14 L120,24 L0,16"
      />
    </svg>
    <svg
      viewBox="0 0 1200 36"
    ...
    >
      ...
      <path
        ...
        strokeWidth="1.5"
        strokeLinejoin="round"
        d="M1200,14 L1186,20 L1177,12 L1160,24 L1149,16 L1137,27 L1128,15 L1112,21 L1098,11 L1086,25 L1071,17 L1063,29 L1049,19 L1034,13 L1020,23 L1008,16 L994,26 L979,14 L968,21 L954,11 L939,24 L927,18 L913,28 L899,15 L884,22 L872,12 L857,25 L843,17 L828,30 L816,20 L801,13 L788,23 L774,16 L760,27 L745,14 L733,21 L718,11 L704,24 L690,18 L677,29 L662,20 L648,13 L634,23 L620,15 L606,26 L591,19 L578,12 L563,22 L549,16 L535,28 L520,21 L507,14 L493,24 L478,17 L464,30 L450,20 L436,12 L421,23 L408,16 L394,26 L379,19 L366,13 L352,22 L337,15 L323,27 L309,21 L295,14 L280,24 L266,17 L252,29 L238,20 L224,12 L209,23 L196,16 L182,25 L167,19 L154,13 L140,22 L126,15 L112,26 L98,20 L84,14 L69,24 L55,17 L41,28 L27,21 L13,15 L0,22"
      />
    </svg>
  </div>
);
