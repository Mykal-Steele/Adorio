...
export const getStatusProps = (status) => {
  ...
  if (s === 'live' || s === 'playable' || s === 'gallery' || s.startsWith('$')) {
...
const CarouselCard = React.memo(({ card }: CarouselCardProps) => (
      ...
      <div className="p-2">
        ...
        <div className="mt-2 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1 text-amber-400">
            ...
            <span className="text-xs font-main font-bold text-green-200">{card.rating}</span>
          </div>
        </div>
      </div>
    </div>
