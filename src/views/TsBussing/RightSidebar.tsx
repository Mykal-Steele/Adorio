...
const RightSidebar = () => {
  return (
    <aside className="w-full z-30 shadow-[-4px_0_24px_rgba(0,0,0,0.5)] h-auto md:h-screen overflow-y-auto border-l-8 border-amber-900 cork-pattern md:col-start-3 md:row-start-1 ts-right-sidebar">
      <div className="p-6 flex flex-col gap-6 relative">
        ...
        <div className="grid grid-cols-1 gap-3 mt-4">
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <Icons.Github />
              <span className="font-poppins font-bold hover:underline">Mykal-Steele</span>
            </div>
          ...
          >
            ...
            <span className="text-[10px] text-neutral-500 font-main mt-1 block">
              - sadly, i can&apos;t email you back with this email, but i WILL reply you back!
            </span>
          </a>
        </div>
        ...
        <div className="bg-amber-50 p-4 shadow-md rotate-[-1.5deg] transform relative mt-4 hover:rotate-[0.5deg] transition-all duration-300">
          ...
          <p className="font-poppins text-neutral-800 text-sm leading-relaxed">
            ...
            <br />
            <span className="text-neutral-500 text-xs font-main ml-2">(hint: tilt)</span>
          </p>
        </div>
      </div>
    </aside>
