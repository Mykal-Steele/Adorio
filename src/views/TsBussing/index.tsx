...
const TsBussing = () => {
  return (
    <div className="min-h-screen text-neutral-200 font-main selection:bg-amber-900 selection:text-white grid grid-cols-1 md:grid-cols-[320px_1fr_280px] md:overflow-y-auto bg-[#2e2e2e] ts-bussing-layout">
      <AdSenseScript />
      {/* Background Image */}
      <div
      ...
      {/* Main Content */}
      <main className="h-auto overflow-visible overflow-x-hidden relative z-10 md:col-start-2 custom-scrollbar ts-main-content">
        <div className="relative z-10 max-w-4xl mx-auto pt-12 pb-24 px-4 md:px-12">
          ...
          {/* Shelves */}
          <Shelf category="Web Dev" iconName="Code" speed={0.5} items={shelfItems.web} />
          <Shelf category="Game Dev" iconName="Play" speed={0.65} items={shelfItems.games} />
          <Shelf category="Artworks" iconName="Hammer" speed={0.8} items={shelfItems.art} />
        </div>
      </main>
