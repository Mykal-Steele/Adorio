  ...
  return (
    <div className='relative'>
      <div
        ...
        style={{
          background: 'linear-gradient(135deg, #8B4513 0%, #A0522D 25%, #8B4513 50%, #6B3E0A 75%, #8B4513 100%)',
      ...
      >
        <div
          ...
          style={{ backgroundImage: 'repeating-linear-gradient(90deg, transparent, transparent 8px, rgba(0,0,0,0.1) 8px, rgba(0,0,0,0.1) 10px)' }}
        />
        <p className='text-amber-100 font-bold text-lg tracking-wide relative z-10' style={{ textShadow: '1px 1px 2px rgba(0,0,0,0.5)' }}>
          {text}
        </p>
      </div>
  ...
  return (
    <div className='w-full'>
      <div
        ...
        style={{ background: 'linear-gradient(180deg, #A0522D 0%, #8B4513 50%, #6B3E0A 100%)', boxShadow: 'inset 0 2px 4px rgba(255,255,255,0.2)' }}
      />
      <div
        className='h-3'
        style={{ background: 'linear-gradient(180deg, #6B3E0A 0%, #5C3317 50%, #4A2511 100%)', boxShadow: '0 4px 8px rgba(0,0,0,0.4)' }}
      />
    </div>
  );
}
...
export default function TempBeforeReal() {
  return (
    <div className='bg-gray-50 text-gray-900 selection:bg-indigo-500 selection:text-white min-h-screen' style={{ fontFamily: "'Inter', sans-serif" }}>
      <AdSenseScript />
      ...
      <nav className='fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-gray-100'>
        <div className='px-6 sm:px-8 lg:px-12'>
          <div className='flex justify-between items-center h-24'>
            <span className='font-bold text-4xl tracking-tight' style={{ width: 256 }}>Adorio</span>
            <div className='flex items-center gap-6'>
              <a href='#' className='hidden md:block text-lg font-medium text-gray-600 hover:text-gray-900'>Sign in</a>
              <a href='#' className='px-6 py-3 bg-gray-900 text-white text-lg font-medium rounded-full hover:bg-gray-800 transition-colors'>Get Started</a>
            </div>
          </div>
        </div>
      </nav>
