...
export class ProblemStorage {
   ...
   */
  static saveProblemState(problemId: string, state: ProblemState) {
   ...
   */
  static loadProblemState(problemId: string, meta: ProblemMeta = {}) {
   ...
   * @param {string} problemId - Problem identifier
   */
  static saveActiveProblem(problemId: string) {
    if (!problemId) return;
   ...
   */
  static hasSavedState(problemId: string): boolean {
   ...
   * @param {string} problemId - Problem identifier
   */
  static clearProblemState(problemId: string) {
    if (!problemId) return;
