...
param pistonUrl = readEnvironmentVariable('PISTON_URL')
param pistonToken = readEnvironmentVariable('PISTON_TOKEN')
param pistonCaCert = readEnvironmentVariable('PISTON_CA_CERT')
